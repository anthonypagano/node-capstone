...
function displayAlbumData(data) {
    for (index in data.albumData) {
	   $('body').append('<ul>',
        '<li><input type="text" id="bandName" value="' + data.albumData[index].bandName + '"/></li>',
        '<li><input type="text" id="albumName"  value="' + data.albumData[index].albumName + '"/></li>',
        '<li><input type="text" id="releaseYear"  value="' + data.albumData[index].releaseYear + '"/></li>',
        '<li><input type="text" id="format"  value="' + data.albumData[index].format + '"/></li>',
        '<li><input type="text" id="notes"  value="' + data.albumData[index].notes + '"/></li>',
        '</ul>');
    }
}
